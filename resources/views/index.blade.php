    ...
    <div id="carouselExampleIndicators" class="carousel slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                ...
                <div class="carousel-caption bg-danger">
                    <a href="#"><h5>WATCHLIST ALERT:GOALKEEPERS</h5></a>
            ...
            <div class="carousel-item">
                ...
                <div class="carousel-caption d-none d-md-block bg-danger">
                    <a  href="#"><h5 class="display-5">TEAM SELECTION</h5></a>
            ...
            <div class="carousel-item">
                ...
                <div class="carousel-caption d-none d-md-block bg-danger">
                    <a href=""><h5>HOW TO SUCCEED IN FPL 2018</h5></a>
